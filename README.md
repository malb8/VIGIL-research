...
- evaluates navigation context
- manages approval tokens
- stores pending navigation state
- validates continuation requests
- manages redirect-chain handling
- protects approval boundaries

## content_click_marker.js

Content script injected into normal web pages.

Responsibilities:

- marks trusted in-browser interactions
- distinguishes browser-origin clicks from external launches
- helps preserve usability during normal browsing
...
- request navigation continuation
